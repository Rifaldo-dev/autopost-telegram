...
mulai = '''
Selamat Datang Di *MENFESS FRC*

kamu bebas mengirim menfess pada channel MENFESSFRC, jika ingin memposting menfess silahkan kirim pesan teks beserta tag dibawah ini :
...
@bot.message_handler(commands=["start", "broadcast", "ping", "about"], chat_types=["private"])
def garz(message):
	id = message.chat.id 
	teks = message.text 
